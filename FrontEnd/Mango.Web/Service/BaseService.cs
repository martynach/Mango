...
namespace Mango.Web.Service
{
    public class BaseService : IBaseService
    {
        ...
        public BaseService(IHttpClientFactory httpClientFactory, ITokenProviderService tokenProvider)
        {
            ...
            try
            {
                ...
                switch (apiResponse.StatusCode)
                {
                    ...
                    case HttpStatusCode.BadRequest:
                        return new() { IsSuccess = false, Message = "baaaad request" };
                    default:
                        return new() { IsSuccess = false, Message = "Some Unknown failure" };
                }
            }
            catch (Exception ex)
            {
